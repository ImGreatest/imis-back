...
import { NotificationControllerService } from 'apps/cabinet/src/controllers/notification/notification-controller.service';
...
export class NotificationController {
  ...
  getBySenderRecipient(
    ...
    return this.notificationService.getBySenderAndRecipient(
      senderId,
      recipientId,
      date,
      visible,
  ...
  @ApiQuery({
    name: 'date',
    description:
      'Helps to use filter on notices => type input(year-month-day) - **_zeroes required_**',
    required: false,
    example: '2024-05-06',
  })
  getByVisible(
